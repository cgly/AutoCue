    ...
    def log_summary(self):
        ...
        summary_table_rows = [
            ...
            [
                ...
                (attack_success_stats["original_accuracy"])/100
            ],
            [
                "Accuracy under attack:",
                #str(attack_success_stats["attack_accuracy_perc"]) + "%",
                (attack_success_stats["attack_accuracy_perc"])/100
            ],
            [
                "Attack success rate:",
                #str(attack_success_stats["attack_success_rate"]) + "%",
                (attack_success_stats["attack_success_rate"])/100
            ],
            [
                "Average perturbed word %:",
                #str(words_perturbed_stats["avg_word_perturbed_perc"]) + "%",
                (words_perturbed_stats["avg_word_perturbed_perc"])/100
            ],
            [
