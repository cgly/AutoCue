...
class Perplexity(Metric):
    def __init__(self, model_name="gpt2"):
        ...
        if model_name == "gpt2":
            ...
            self.ppl_model = GPT2LMHeadModel.from_pretrained(r"E:\code\textcode\Pro-CLARE\MLM_model\gpt2")
            self.ppl_model.to(textattack.shared.utils.device)
            self.ppl_tokenizer = GPT2Tokenizer.from_pretrained(r"E:\code\textcode\Pro-CLARE\MLM_model\gpt2")
            self.ppl_model.eval()
