...
#     'prompt_template': '{0} news: ',
#     'prompt_location': 'front',  # front or rear
#     'prompt_target':'target' # target or ori or
#     #ori 中只能选择原始类攻击
# }
nclasses = {'ag': 4, 'yelp': 2, 'yahoo': 10, 'dbpedia': 14,
...
thres = {
    ...
    #                     'replace_sim': 0.6, 'insert_sim': -1.0, 'merge_sim': 0.8,
    #                     'prob_diff': -1e-4,
    #                     'sim_window': 15},
    #1000 2022年3月17日09:18:23
    ...
    #2022年3月16日20:48:52
    # 'ag': {'replace_prob': 0.0005, 'insert_prob': 0.0, 'merge_prob': 0.005,
    #                 'replace_sim': 0.8, 'insert_sim': -1.0, 'merge_sim': 0.8,
    #                 'prob_diff': -1e-4,
    #                 'sim_window': 15},
    #2022年3月16日19:19:51
    # 'ag': {'replace_prob': 0.0005, 'insert_prob': 0.0, 'merge_prob': 0.005,
    #             'replace_sim': 0.8, 'insert_sim': -1.0, 'merge_sim': 0.7,
    #             'prob_diff': -1e-4,
    #             'sim_window': 15},
    #2022年3月16日16:56:58
    # 'ag': {'replace_prob': 0.0005, 'insert_prob': 0.0, 'merge_prob': 0.005,
